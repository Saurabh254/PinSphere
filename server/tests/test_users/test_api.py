...
def test_create_new_user(mock_db_session):
    user_data = User(username="newuser", email="newuser@example.com", password="password", password_salt='password_salt')
...
def test_update_existing_user(mock_db_session):
    user_data = User(username="newusername", email="newuser@example.com")
