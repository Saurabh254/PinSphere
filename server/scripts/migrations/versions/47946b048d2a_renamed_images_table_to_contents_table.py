...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PROCESSING", "PROCESSED", name="content_processing_enum"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "image_key", sa.VARCHAR(length=256), autoincrement=False, nullable=False
        ),
        sa.Column(
            "status",
            postgresql.ENUM("PROCESSING", "PROCESSED", name="image_processing_enum"),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["username"], ["users.username"], name="images_username_fkey"
        ),
