...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PROCESSING", "PROCESSED", name="image_processing_enum"),
            nullable=False,
        ),
...
def downgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "image_key", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "status",
            postgresql.ENUM("PROCESSED", "PROCESSING", name="status_enum"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column("deleted", sa.BOOLEAN(), autoincrement=False, nullable=False),
        sa.Column(
            "blurhash", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["username"], ["users.username"], name="user_photos_username_fkey"
        ),
